...
import { generateRegelsMemoryPairs } from '../../utils/verkeerData';

function VerkeerRegelsMemory({ mathSettings, onSuccess, onFailure }) {
...
export default VerkeerRegelsMemory;
