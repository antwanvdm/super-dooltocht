...
import { generateDigitaalMemoryPairs } from '../../utils/digitaalData';

function DigitaalMemory({ onSuccess, onFailure }) {
  ...
  return (
    <div>
      <p className="text-base sm:text-xl text-gray-600 text-center mb-4 sm:mb-6">
        Zoek het woord bij de juiste uitleg!
      </p>
              ...
              className={`aspect-square rounded-xl font-bold text-[10px] sm:text-xs transition-all flex items-center justify-center p-1 ${
                isMatched
                  ...
                  : isWrong
                    ...
                    : isFlipped
                      ? 'bg-slate-100 text-gray-800 border-2 border-slate-400'
