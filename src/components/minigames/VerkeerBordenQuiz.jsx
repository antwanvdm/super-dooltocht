...
import { generateBordenQuestion } from '../../utils/verkeerData';
import TrafficSignSVG from './TrafficSignSVG';

function VerkeerBordenQuiz({ mathSettings, onSuccess, onFailure }) {
  ...
  return (
    <div className="text-center">
      <div className="mb-4 sm:mb-6">
        <p className="text-gray-600 text-sm sm:text-lg mb-2">🪧 Verkeersborden</p>
        <div className="inline-flex flex-col items-center gap-2 bg-gradient-to-br from-sky-100 to-blue-100 rounded-2xl px-4 sm:px-8 py-4 sm:py-6 border-2 border-sky-200">
          {problem.svg && <TrafficSignSVG sign={problem.svg} size={80} />}
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 sm:gap-3 max-w-xl mx-auto">
        {options.map((option, index) => {
          let btnClass = 'bg-white border-2 border-gray-200 text-gray-700 hover:border-sky-400 hover:bg-sky-50';
...
export default VerkeerBordenQuiz;
