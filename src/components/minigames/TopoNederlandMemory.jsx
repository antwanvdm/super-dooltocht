...
import { generateNederlandMemoryPairs } from '../../utils/topografieData';

function TopoNederlandMemory({ mathSettings, onSuccess, onFailure }) {
...
export default TopoNederlandMemory;
