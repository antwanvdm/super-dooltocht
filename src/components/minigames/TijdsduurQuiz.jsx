...
import { generateTijdsduurQuestion } from '../../utils/timeCalculationData';

/**
 * TijdsduurQuiz - Multiple choice: Hoe lang duurt het van X tot Y?
 * Bij dagen & weken: Hoeveel dagen/weken?
 */
function TijdsduurQuiz({ mathSettings, onSuccess, onFailure }) {
  ...
  useEffect(() => {
    ...
    const q = generateTijdsduurQuestion(level, use24h);
    setProblem(q);
