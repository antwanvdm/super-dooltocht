...
import { generateEuropaQuestion } from '../../utils/topografieData';

function TopoEuropaQuiz({ mathSettings, onSuccess, onFailure }) {
  ...
  return (
    <div className="text-center">
      <div className="mb-4 sm:mb-6">
        <p className="text-gray-600 text-sm sm:text-lg mb-2">🇪🇺 Europa</p>
        <div className="inline-block bg-gradient-to-br from-blue-100 to-indigo-100 rounded-2xl px-4 sm:px-8 py-4 sm:py-6 border-2 border-blue-200">
