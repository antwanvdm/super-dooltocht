...
import { generateNederlandQuestion } from '../../utils/topografieData';

function TopoNederlandQuiz({ mathSettings, onSuccess, onFailure }) {
  ...
  return (
    <div className="text-center">
      <div className="mb-4 sm:mb-6">
        <p className="text-gray-600 text-sm sm:text-lg mb-2">🇳🇱 Nederland</p>
...
export default TopoNederlandQuiz;
